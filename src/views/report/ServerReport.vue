<template>
    <div  style="margin-top: 10px; margin-left: 10px; margin-right: 10px">
      <div>
        <el-select  v-model="searchForms.report_type"  placeholder="请选择" size="small" style="width: 150px">
          <el-option
        ...
        <el-input v-model="searchForms.report_name" placeholder="报告名称" style="width: 200px;"  size="small"  class="filter-item"  />
        <el-button size="small" style="margin-left: 10px" type="primary"  icon="el-icon-search" @click="handleFilter" plain>Search</el-button>
        <el-button size="small" type="primary" icon="el-icon-plus" @click="handleAddBtn" plain>创建报告</el-button>
      </div>
      <el-table :data="reportList"
                v-loading="loading"
                element-loading-text="Loading..."
                style="width: 100%; margin-top: 20px">
        <el-table-column prop="report_name"  label="报告名"  width="200px" align="center"></el-table-column>
        <el-table-column prop="report_type"  label="报告类型" align="center" width="150px">
        ...
        <el-table-column prop="report_create_time"  label="创建时间" width="180px" align="center"></el-table-column>
        <el-table-column prop="report_start_timestamp"  label="报告截止时间" width="180px" align="center"></el-table-column>
        <el-table-column prop="report_period"  label="报告周期(s)" align="center" width="160px">
          <template slot-scope="{row}">
        ...
        <el-table-column prop="report_hosts"  label="主机列表" align="center" width="250px">
          <template slot-scope="{row}">
      ...
      <div class="text-center" v-show="totalNum>=10">
        <el-pagination background layout="prev, pager, next" @current-change="handleCurrentChange" :total="totalNum">
        </el-pagination>
      </div>
      <el-dialog title="添加报告" :visible.sync="dialogVisibleForAddReport" width="500px">
        <el-form ref="addReportFile" :model="addReport" label-width="80px" >
          ...
          <el-form-item label="报告开始时间" prop="report_start_timestamp" >
          <el-date-picker
            style="width: 100%"
          ...
          <el-form-item label="报告周期" prop="report_period">
            <el-select v-model="addReport.report_period"   filterable allow-create placeholder="请输入(单位：s)或选择报告周期" style="width:100%">
              <el-option
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="handleCancelAddReport">取 消</el-button>
