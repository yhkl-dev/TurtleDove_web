<template>
    <div>
      <el-table :data="adhocTaskLists"
        ...
        <el-table-column prop="exec_host"  label="执行主机" align="center" ></el-table-column>
        <el-table-column prop="model_name"  label="模块名称"  width="80px"align="center" ></el-table-column>
        <el-table-column prop="model_args"  label="模块参数" align="center" ></el-table-column>
        <el-table-column label="执行结果" width="250px" align="center">
          <template slot-scope="scope" >
      ...
      <div class="text-center" v-show="adhocTotalNum>=10">
        <el-pagination
          background
      ...
      <el-dialog v-el-drag-dialog :visible.sync="dialogTableVisible" title="Ad-hoc Result" width="70%"  @dragDialog="false && handleDrag(scope.row)">
        <div class="divcalss">
...
<script>
  ...
  export default {
    name: 'AdhocTask',
    props: ['params', 'adhocTaskLists', 'statusOptions', 'adhocTotalNum'],
    ...
    data() {
      return {
        ...
        adhocTaskList: this.adhocTaskLists,
        result_page: 1,
        ChangeTaskStatus: {
          id: '',
          name: '',
    ...
    methods: {
      ...
      handleCurrentChange(val) {
        this.$emit('handleCurrentChangeAdhoc', val)
      },
      handleEditClick(row) {
        this.updateTask(row)
        this.$emit('handleEditAdhocClick', this.ChangeTaskStatus)
      },
