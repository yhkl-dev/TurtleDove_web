<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="workOrderTaskDetailVisible"
      ...
      <work-order-history-audit-detail  v-bind:workOrderDetail="workOrderDetail">
      </work-order-history-audit-detail>
    </el-dialog>
  </div>
...
<script>
  import workOrderHistoryAuditDetail from './workOrderHistoryAuditDetail'
  export default {
    name: 'MyExecWorkOrderList',
    components: { workOrderHistoryAuditDetail },
    props: ['workOrderAuditHistoryList', 'auditLoading', 'auditTotalNum', 'workOrderModelList'],
    data() {
      return {
    ...
    methods: {
      ...
      handleFilter() {
        ...
        this.$emit('handleSearchAuditTask', this.searchForm)
      }
    }
  }
</script>
