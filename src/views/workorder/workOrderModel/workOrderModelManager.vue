<template>
  ...
  <el-card >
    ...
    <el-dialog title="创建模板"  :visible.sync="addDialogVisible" width="20%" center>
  ...
  export default {
    ...
    methods: {
      ...
      handleEditWorkOrderModel(row) {
        ...
        const { id, model_create_time, model_name, mode_status, order_type, order_flow_type } = row
        this.changeModelForm = { id, model_create_time, model_name, mode_status, order_type, order_flow_type }
      },
